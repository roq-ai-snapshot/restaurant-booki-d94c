...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Chefs', path: '/chefs', entity: 'chef', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Guests', path: '/guests', entity: 'guest', service: AccessServiceEnum.PROJECT, icon: FiUserPlus },
