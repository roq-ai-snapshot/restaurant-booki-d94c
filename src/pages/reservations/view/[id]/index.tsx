        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Guest Name" text={data?.guest_name} />
                ...
                <FormListItem
                  ...
                  text={
                    data?.reservation_date
                      ? format(parseISO(data?.reservation_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.reservation_time
                      ? format(parseISO(data?.reservation_time as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
