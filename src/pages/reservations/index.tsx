...
export function ReservationListPage(props: ReservationListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReservations({
        ...
        order: params.order,
        searchTermKeys: ['guest_name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'guest_name', header: 'Guest Name', accessorKey: 'guest_name' },
    { id: 'guest_count', header: 'guest_count', accessorKey: 'guest_count' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.reservation_date ? format(parseISO(record?.reservation_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'reservation_time',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.reservation_time ? format(parseISO(record?.reservation_time as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'date_created',
      header: 'Date Created',
