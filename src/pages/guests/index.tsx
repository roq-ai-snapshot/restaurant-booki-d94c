...
export function GuestListPage(props: GuestListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getGuests({
        ...
        order: params.order,
        searchTermKeys: ['favorite_cuisine.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'favorite_cuisine', header: 'Favorite Cuisine', accessorKey: 'favorite_cuisine' },
    { id: 'total_reservations', header: 'total_reservations', accessorKey: 'total_reservations' },
    {
      id: 'date_created',
      header: 'Date Created',
