...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        relations: ['user', 'chef.count', 'guest.count', 'menu.count', 'reservation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('chef', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'chef',
          header: 'Chef',
          accessorKey: 'chef',
          cell: ({ row: { original: record } }: any) => record?._count?.chef,
        }
      : null,
    hasAccess('guest', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          header: 'Guest',
          accessorKey: 'guest',
          cell: ({ row: { original: record } }: any) => record?._count?.guest,
        }
      : null,
